...
class CarpalTestRunListener : public Catch::EventListenerBase {
public:
    using Catch::EventListenerBase::EventListenerBase;

    void testRunStarting(Catch::TestRunInfo const&) override {
        m_logFile.open("carpal-test.log", std::ios_base::binary | std::ios_base::out | std::ios_base::app);
        carpal::g_logger->setMinLevel(carpal::Logger::Level::debug);
...
CATCH_REGISTER_LISTENER(CarpalTestRunListener)
